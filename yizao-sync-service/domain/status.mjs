...
const TASK_TRANSITIONS = Object.freeze({
  ...
  [TASK_STATUS.SAVING_DRAFT]: Object.freeze([TASK_STATUS.DRAFT_SAVED, TASK_STATUS.FAILED, TASK_STATUS.CANCELLED]),
  [TASK_STATUS.DRAFT_SAVED]: Object.freeze([TASK_STATUS.WAITING_CONFIRMATION, TASK_STATUS.FAILED]),
